...
TEST_F (triangle1_test, inside_triangle)
{
        ...
        ASSERT_TRUE(triangle.has_inside(point1));
        ASSERT_TRUE(triangle.has_inside(point2));
        ASSERT_TRUE(triangle.has_inside(point3));
}
...
TEST_F (triangle1_test, outside_triangle)
{
        ...
        ASSERT_FALSE(triangle.has_inside(point1));
        ASSERT_FALSE(triangle.has_inside(point2));
        ASSERT_FALSE(triangle.has_inside(point3));
}
